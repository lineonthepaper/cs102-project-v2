...
public class FullDatabaseExportService {
    ...
    public byte[] exportEntireDatabaseAsZip() throws IOException {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        ZipOutputStream zos = new ZipOutputStream(baos);

        // Export each table as separate CSV file in the ZIP
        addTableToZip(zos, "users", exportUsers());
        addTableToZip(zos, "courses", exportCourses());
        addTableToZip(zos, "sections", exportSections());
        addTableToZip(zos, "section_enrollments", exportSectionEnrollments());
        addTableToZip(zos, "section_assignments", exportSectionAssignments());
        addTableToZip(zos, "ta_assignments", exportTAAssignments());
        addTableToZip(zos, "attendance_sessions", exportAttendanceSessions());
        addTableToZip(zos, "attendance_records", exportAttendanceRecords());
    ...
    private void addTableToZip(ZipOutputStream zos, String tableName, String csvData) throws IOException {
    ...
    private String exportUsers() throws IOException {
    ...
    private String exportCourses() throws IOException {
        StringWriter writer = new StringWriter();
    ...
    private String exportSections() throws IOException {
        StringWriter writer = new StringWriter();
    ...
    private String exportSectionEnrollments() throws IOException {
        StringWriter writer = new StringWriter();
    ...
    private String exportSectionAssignments() throws IOException {
        StringWriter writer = new StringWriter();
    ...
    private String exportTAAssignments() throws IOException {
        StringWriter writer = new StringWriter();
    ...
    private String exportAttendanceSessions() throws IOException {
        StringWriter writer = new StringWriter();
    ...
    private String exportAttendanceRecords() throws IOException {
        StringWriter writer = new StringWriter();
